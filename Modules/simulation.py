...
class simulation(particle_props):
    ...
    #instantiation
    def __init__(self, dt = 0.1, n_particles = 2, radius_input = [1, 2], max_velocity = 50, mass = 10, temperature = 100,
                 box_width = 200, box_height = 200, n_dimension = 2, root_path = None, save_path = None):
    ...
    def update_r(self, copy_matrix = False):
        ...
        new_value = self.r().copy() + (self.v().copy() * self.dt) + ( (1/2) * self.a().copy() * (self.dt ** 2 ) )
    ...
    def run(self, n_iterations = 100):
        ...
        self.balls_initial_accelerations(random_val = False, val = (0, 0))
